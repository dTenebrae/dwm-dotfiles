...
export ZSH="/home/tenebrae/.oh-my-zsh"
...
PATH="/home/tenebrae/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/tenebrae/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
